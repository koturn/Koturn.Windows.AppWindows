...
#pragma warning restore IDE0079 // Remove unnecessary suppression
{
    ...
    internal enum WindowStyleFlags : uint
    {
        ...
        /// To change this style after a window has been created, use the <see cref="WindowUtil.SafeNativeMethods.SetWindowLongPtr(IntPtr, int, nuint)"/> function.
        ...
        /// use the <see cref="WindowUtil.SafeNativeMethods.SetWindowLongPtr(IntPtr, int, nuint)"/> function.
        /// </para>
        /// </summary>
        Group = 0x00020000,
        /// <summary>
        ...
        /// <para>This style can be turned on and off by using the <see cref="WindowUtil.SafeNativeMethods.ShowWindow(IntPtr, CmdShow)"/>
        /// or <see cref="WindowUtil.SafeNativeMethods.SetWindowLongPtr(IntPtr, int, nuint)"/> function.</para>
        /// </summary>
        Visible = 0x10000000,
        /// <summary>
